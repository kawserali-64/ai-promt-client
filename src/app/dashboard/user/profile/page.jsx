        ...
        <div className="flex flex-col sm:flex-row items-center gap-5 sm:gap-6 text-center sm:text-left">
          ...
          <div className="flex-1 space-y-2">
            ...
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 pt-1">
              ...
              <span className={`text-[10px] font-bold tracking-wider px-3 py-1 rounded-full uppercase border ${isPremium ? "bg-amber-500/10 text-amber-400 border-amber-500/20" : "bg-zinc-800/50 text-zinc-400 border-white/5"
                }`}>
                PLAN: {user.plan || "free"}
              </span>
            </div>
          ...
          <div className="flex items-start gap-4 relative z-10">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm">
                Unlock private templates, verified analytics, premium prompts and more.
              </p>
            </div>
          </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-400">
                  Your premium membership is active. Enjoy all premium features.
                </p>
              </div>
            </div>
