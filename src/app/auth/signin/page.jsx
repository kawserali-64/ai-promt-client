...
const SigninPage = () => {
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-gray-50 dark:bg-[#09090b] px-4 py-12 transition-colors duration-300">
      ...
      {/* ব্যাকগ্রাউন্ড প্যাটার্ন (লাইট ও ডার্ক মোডের জন্য অপ্টিমাইজড) */}
      ...
      <div className="absolute top-1/2 left-1/2 h-[450px] w-[450px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-indigo-600/10 blur-[130px] pointer-events-none"></div>
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-gray-200 dark:border-white/5 bg-white/80 dark:bg-[#0e0e12]/90 p-8 shadow-xl dark:shadow-[0_20px_50px_rgba(0,0,0,0.6)] backdrop-blur-xl transition-colors duration-300">
        ...
        <div className="mb-6 text-center">
          <h2 className="text-2xl font-black tracking-tight text-gray-900 dark:text-white sm:text-3xl">
            Welcome <span className="bg-gradient-to-r from-violet-600 to-indigo-600 dark:from-violet-400 dark:to-indigo-400 bg-clip-text text-transparent">Back</span>
          </h2>
          <p className="mt-2 text-xs text-gray-500 dark:text-zinc-400">Sign in to access your engineering-grade prompt ecosystem.</p>
        </div>
        ...
        <Form className="flex flex-col gap-4" onSubmit={onSubmit}>
          ...
          >
            ...
            <Input
              ...
              className="rounded-xl border border-gray-300 dark:border-white/5 bg-gray-50 dark:bg-zinc-900/50 text-gray-900 dark:text-white focus-within:border-violet-500/40 transition-all"
            />
          ...
          <TextField isRequired name="password" type="password">
            <div className="flex items-center justify-between mb-1">
              <Label className="text-gray-700 dark:text-zinc-300 font-medium text-xs">Password</Label>
            </div>
            <Input
              placeholder="••••••••"
              className="rounded-xl border border-gray-300 dark:border-white/5 bg-gray-50 dark:bg-zinc-900/50 text-gray-900 dark:text-white focus-within:border-violet-500/40 transition-all"
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500 dark:text-zinc-500">
            ...
            <Link href="/auth/signup" className="inline-flex items-center gap-0.5 font-medium text-violet-600 dark:text-violet-400 hover:text-violet-500 dark:hover:text-violet-300 hover:underline">
